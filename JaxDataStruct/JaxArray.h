...
namespace Jax
{
	...
	class JaxArray : public JaxContainer<T, MMFun>
	{
	public:
		enum
		{
		...
		JaxArray(size_t growBy = DEFAULT_GROWBY);
		~JaxArray();
		JaxArray(const JaxArray& Array);
		void SetBufferNum(size_t bufferNum);
		void AddBufferNum(size_t bufferNum);
		void operator=(const JaxArray<T, MMFun>& Array);
		...
		void AddElement(const JaxArray<N, MMFunN>& Array, size_t begin, size_t end);
		...
		template<typename N>
		void Sort(size_t begin, size_t end, N Compare);
		void Sort(size_t begin, size_t end);
		void Destory();
		size_t FindElement(const T& element);
...
//	inline JaxArray<T, MMFun>::JaxArray(size_t growBy)
//	{
//		m_uiGrowBy = growBy;
//		m_pBuffer = NULL;
//		m_uiCurUse = 0;
...
//
//	template<typename T, JaxMemManagerFun MMFun>
//	inline JaxArray<T, MMFun>::~JaxArray()
//	{
...
//
//	template<typename T, JaxMemManagerFun MMFun>
//	inline JaxArray<T, MMFun>::JaxArray(const JaxArray& Array)
//	{
...
//
//	template<typename T, JaxMemManagerFun MMFun>
//	inline void JaxArray<T, MMFun>::SetBufferNum(size_t bufferNum)
//	{
//		if (bufferNum)
//		{
//			Delete(m_pBuffer, m_uiCurUse);
...
//
//	template<typename T, JaxMemManagerFun MMFun>
//	inline void JaxArray<T, MMFun>::AddBufferNum(size_t bufferNum)
//	{
//		if (bufferNum)
//		{
//			m_uiAllocNum++;
...
//
//	template<typename T, JaxMemManagerFun MMFun>
//	inline void JaxArray<T, MMFun>::operator=(const JaxArray<T, MMFun>& Array)
//	{
...
//
//	template<typename T, JaxMemManagerFun MMFun>
//	inline size_t JaxArray<T, MMFun>::GetNum() const
//	{
//		return m_uiCurUse;
//	}
//
//	template<typename T, JaxMemManagerFun MMFun>
//	inline size_t JaxArray<T, MMFun>::GetBufferNum() const
//	{
//		return m_uiBufferNum;
//	}
//
//	template<typename T, JaxMemManagerFun MMFun>
//	inline T* JaxArray<T, MMFun>::GetBuffer() const
//	{
//		return m_pBuffer;
//	}
//
//	template<typename T, JaxMemManagerFun MMFun>
//	inline void JaxArray<T, MMFun>::SetGrowBy(size_t growBy)
//	{
//		m_uiGrowBy = growBy;
//	}
//
//	template<typename T, JaxMemManagerFun MMFun>
//	inline void JaxArray<T, MMFun>::AddElement(const T& element)
//	{
...
//
//	template<typename T, JaxMemManagerFun MMFun>
//	inline T& JaxArray<T, MMFun>::operator[](size_t i) const
//	{
//#ifdef _DEBUG
...
//
//	template<typename T, JaxMemManagerFun MMFun>
//	inline void JaxArray<T, MMFun>::Clear()
//	{
//		if (m_uiCurUse == 0)
//			return;
...
//
//	template<typename T, JaxMemManagerFun MMFun>
//	inline size_t JaxArray<T, MMFun>::GetSize() const
//	{
//		return size_t();
//	}
//
//	template<typename T, JaxMemManagerFun MMFun>
//	inline void JaxArray<T, MMFun>::Erase(size_t i)
//	{
//		if (i < m_uiCurUse)
//		{
//			Erase(i, i);
...
//
//	template<typename T, JaxMemManagerFun MMFun>
//	inline void JaxArray<T, MMFun>::Erase(size_t begin, size_t end)
//	{
//		if (end >= m_uiCurUse)
//		{
//			end = m_uiCurUse - 1;
...
//
//	template<typename T, JaxMemManagerFun MMFun>
//	inline void JaxArray<T, MMFun>::Sort(size_t begin, size_t end)
//	{
//		if (end >= m_uiCurUse)
//		{
//			end = m_uiCurUse - 1;
...
//
//	template<typename T, JaxMemManagerFun MMFun>
//	inline void JaxArray<T, MMFun>::Destory()
//	{
//		Clear();
//		Delete(m_pBuffer, m_uiCurUse);
//	}
//
//	template<typename T, JaxMemManagerFun MMFun>
//	inline size_t JaxArray<T, MMFun>::FindElement(const T& element)
//	{
//		for (size_t i = 0; i < m_uiCurUse; ++i)
//		{
...
//	template<typename T, JaxMemManagerFun MMFun>
//	template<typename N, JaxMemManagerFun MMFunN>
//	inline void JaxArray<T, MMFun>::AddElement(const JaxArray<N, MMFunN>& Array, size_t begin, size_t end)
//	{
//		if (begin > end)
//		{
//			return;
...
//	template<typename T, JaxMemManagerFun MMFun>
//	template<typename N>
//	inline void JaxArray<T, MMFun>::Sort(size_t begin, size_t end, N Compare)
//	{
//		if (end >= m_uiCurUse)
//		{
//			end = m_uiCurUse - 1;
